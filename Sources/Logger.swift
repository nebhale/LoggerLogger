...
public final class Logger {
    ...
    - parameter name:                  The name of the logger.  Defaults to the `basename` of the file containing the declaration.
    - parameter configurationProvider: The `ConfigurationProvider` to use.  Defaults to `ConfigurationProviderManager.defaultInstance`
    - parameter messageWriter:         The `MessageWriter` to use.  Defaults to `MessageWriterManager.defaultInstance`.
    */
    ...
    - parameter column:          The column the log message was generated at.  This argument is populated automatically.
    - parameter file:            The file the log message was generated in.  This argument is populated automatically.
    - parameter function:        The function the log message was generated in.  This argument is populated automatically.
    - parameter line:            The line the log message was generated at.  This argument is populated automatically.
    */
    ...
    */
    ...
    private func log(column column: Int, file: String, function: String, level: Level, line: Int, @noescape messageProvider: MessageProvider) {

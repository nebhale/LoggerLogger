...
/// An implementation of ``MessageWriter`` that outputs to the console via ``println``
public final class ConsoleMessageWriter: MessageWriter {
    ...
    ///
    /// :param: messageFormatter The ``MessageFormatter`` to use.  Defaults to the ``DefaultMessageFormatter``.
